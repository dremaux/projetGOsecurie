				...
				while (linel != null) {
					...
					if(find) {
						...
						for(int i = 1; i < s.length;i++) {
							writer.print("<img src="https://github.com/dremaux/projetGOsecurie/blob/a2fa939bc7a73bea276b5c0be9e2d4ff87b9669b/src/img/ok.jpg%22%3E"+s[i] + " ");
						}
						writer.print("<br>");
						...
						for(int i = 1; i < s.length;i++) {
							writer.print("<img src="https://github.com/dremaux/projetGOsecurie/blob/a2fa939bc7a73bea276b5c0be9e2d4ff87b9669b/src/img/pasok.png%22%3E"+s[i] + " ");
						}
						writer.print("<br>");
					}
					linel = brl.readLine();
