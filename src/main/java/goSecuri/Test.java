		...
		try {
			...
			try {
				...
				while (linel != null) {
					...
					if(find) {
						find = false;
						writer.print("<img src=\"https://raw.githubusercontent.com/dremaux/projetGOsecurie/a376a8978be4543d8290e4b6f3297af0bc16ceab/src/img/ok.jpg\">");
						...
						writer.print("<img src=\"https://raw.githubusercontent.com/dremaux/projetGOsecurie/a376a8978be4543d8290e4b6f3297af0bc16ceab/src/img/pasok.png\">");
						for(int i = 1; i < s.length;i++) {
							writer.print(s[i] + " ");
						}
						writer.print("<br>");
