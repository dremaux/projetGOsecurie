				...
				while (linel != null) {
					...
					if(find) {
						...
						for(int i = 1; i < s.length;i++) {
							writer.print("<img src=\"https://github.com/dremaux/projetGOsecurie/blob/a376a8978be4543d8290e4b6f3297af0bc16ceab/src/img/ok.jpg\">" + s[i] + " ");
						...
						for(int i = 1; i < s.length;i++) {
							writer.print("<img src=\"https://github.com/dremaux/projetGOsecurie/blob/a376a8978be4543d8290e4b6f3297af0bc16ceab/src/img/pasok.jpg\">"+s[i] + " ");
						}
						writer.print("<br>");
					}
					linel = brl.readLine();
